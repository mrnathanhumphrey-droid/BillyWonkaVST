...
if [ -d "$SCRIPT_DIR/VST3/Groove Engine RnB.vst3" ]; then
  ditto "$SCRIPT_DIR/VST3/Groove Engine RnB.vst3" "$VST3_DIR/Groove Engine RnB.vst3"
...
if [ -d "$SCRIPT_DIR/AU/Groove Engine RnB.component" ]; then
  ditto "$SCRIPT_DIR/AU/Groove Engine RnB.component" "$AU_DIR/Groove Engine RnB.component"
